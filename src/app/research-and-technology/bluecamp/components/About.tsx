export default function About() {
  return (
    <section id='tentang' className='bg-[#f3f7fc]'>
      <div
        id='tentang'
        className='bg-[] mx-auto grid max-w-[1180px] grid-cols-1 items-start gap-16 px-6 py-[118px] md:px-8 lg:grid-cols-[0.9fr_1.1fr]'
      >
        <div className='lg:sticky lg:top-[120px]'>
          ...
          <div className='flex items-center gap-4 rounded-[4px] border border-[#e4e9f0] bg-[#f3f7fc] p-[22px_24px] shadow-sm'>
        ...
        <div className='text-[1.22rem] leading-[1.74] text-[#3a424e]'>
          <p className='mb-[1.3em] text-justify text-wrap'>
            ...
            mewadahi rangkaian proses tersebut melalui berbagai sesi
            pembelajaran, diskusi, serta pengembangan proyek yang berfokus pada
            bidang keilmiahan.
          </p>
